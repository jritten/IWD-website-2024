...
function Sponsors() {
  return (
    <div className="sponsors-div">Sponsors

          <div></div>
      <img
        id="underline"
        alt="Underline"
        src="https://www.bing.com/images/blob?bcid=T3-7WF8.4LgG393pZeZhXTf.R.dE.....1Q"
      />

<div></div>
      <img
        id="SWE"
        alt="SWE sponsor image"
